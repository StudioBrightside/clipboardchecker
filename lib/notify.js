var vNotify = (function () {
  ...
  var addClose = function (parent) {
    ...
    item.addEventListener("click", function () {
      ...
      document.querySelectorAll(".vnotify-highlight").forEach(function (s) {
        s.classList.remove("vnotify-highlight");
      });
    });
    return item;
  };
  ...
  var getOptions = function (opts) {
    return {
      ...
      postHoverVisibleDuration:
        opts.postHoverVisibleDuration || options.postHoverVisibleDuration,
